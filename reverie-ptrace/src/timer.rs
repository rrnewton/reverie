...
impl PrivateExecutionTimerSuspension {
    ...
    pub(crate) fn guest_pid(&self) -> Pid {
        self.snapshot.retained.guest_pid
    }

    pub(crate) fn guest_tid(&self) -> Tid {
        self.snapshot.retained.guest_tid
    }
}
...
impl Timer {
    ...
    pub(crate) fn diagnostic_clock(&self) -> Option<u64> {
        self.inner_noinit().map(TimerImpl::read_clock)
    }
    ...
    pub(crate) fn suspend_for_private_execution(
        &mut self,
...
impl TimerImpl {
    ...
    pub fn suspend_for_private_execution(
        &mut self,
    ) -> Result<PrivateExecutionTimerSuspension, PrivateExecutionTimerError> {
