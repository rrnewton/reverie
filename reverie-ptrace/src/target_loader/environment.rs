...
// Exact second provider selected by the reviewed staging graph (GNU build ID
// a0c9599772f18aa10b6f2220ec80f9b6f7a63994). Its counter-guarded getenv has
// the same control flow as the profile above, but three complete RIP-relative
// displacements and all corresponding data RVAs differ by 0x1000. Keep the
// whole provider and full code bytes distinct; no displacement normalization
// or provider-family admission is permitted.
const COUNTER_GUARDED_V2_LIBC_SHA256: [u8; 32] = [
...
const COUNTER_GUARDED_V2_GETENV_RVA: u64 = 0x428a0;
const COUNTER_GUARDED_V2_ENVIRONMENT_OBJECT_RVA: u64 = 0x2043a0;
const COUNTER_GUARDED_V2_GETENV_GOT_RVA: u64 = 0x1fbfa8;
const COUNTER_GUARDED_V2_GETENV_CODE: &[u8] = &[
    ,
];
...
const COUNTER_GUARDED_V2_BOOKKEEPING: StaticBookkeeping = StaticBookkeeping {
    counter_rva: 0x1fe780,
    allocation_list_rva: 0x1fe788,
};

const COUNTER_GUARDED_V2_GETENV_PROFILE: ReviewedGetenvProfile = ReviewedGetenvProfile {
    provider_sha256: COUNTER_GUARDED_V2_LIBC_SHA256,
    code: COUNTER_GUARDED_V2_GETENV_CODE,
    address: COUNTER_GUARDED_V2_GETENV_RVA,
    got: COUNTER_GUARDED_V2_GETENV_GOT_RVA,
    object: COUNTER_GUARDED_V2_ENVIRONMENT_OBJECT_RVA,
    bookkeeping: Some(COUNTER_GUARDED_V2_BOOKKEEPING),
};

const REVIEWED_GETENV_PROFILES: &[ReviewedGetenvProfile] = &[
...
impl<'a> EnvironmentProvider<'a> {
    ...
    /// no profiles beyond the reviewed whole-provider profiles above.
...
fn validate_getenv_data_accesses(
    ...
    let mut selected = None;
    for profile in REVIEWED_GETENV_PROFILES
        .iter()
        .chain(additional_profiles.iter())
    {
