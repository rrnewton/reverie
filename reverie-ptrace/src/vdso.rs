...
mod vdso_getrandom_x86_64 {
    ...
    //! general fallback. That fallback's complete five-byte syscall-number load
    //! is redirected to a private out-of-line callback trampoline. The original
    //! internal syscall and following jump are never patched or displaced. The
    //! image's sole indirect call is guarded at its SGX callback-target producer.
    ...
    pub(super) const SGX_GUARD_DISPLACED_LEN: usize =
        SGX_INDIRECT_CALL_OFFSET - SGX_TARGET_LOAD_OFFSET;
    pub(super) const SGX_GUARD_SOURCE: [u8; 9] =
        [0x48, 0x8b, 0x40, 0x18, 0x0f, 0xae, 0xe8, 0xff, 0xd0];

    const FORCE_GENERAL_FALLBACK: [u8; 5] = [0xe9, 0xb8, 0x03, 0x00, 0x00];
    const GENERAL_FALLBACK_INSTRUCTION: [u8; 5] = [0xb8, 0x3e, 0x01, 0x00, 0x00];
    const INTERNAL_SYSCALL_WORD: [u8; 8] = [0x0f, 0x05, 0xe9, 0x6a, 0xff, 0xff, 0xff, 0x90];

    // Exact bytes of the sole complete vDSO image admitted for the getrandom
    // adapter. Hex is only a compact source representation: admission compares
    ...
    pub(super) const KNOWN_GETRANDOM: &[u8; 1122] = &[
        ...
        ,
    ];
    ...
    mod tests {
        ...
        fn apply(plan: PatchPlan) -> Vec<u8> {
            ...
            bytes[plan.normal_branch_offset
                ..plan.normal_branch_offset + plan.normal_branch_bytes.len()]
                .copy_from_slice(&plan.normal_branch_bytes);
            bytes
        }

        const MARKER_ADAPTER_OFFSET: usize = 0x480;
        const MARKER_ADAPTER_RESULT: isize = -0x1234;

        fn rel32(from: usize, target: usize) -> [u8; 4] {
            let displacement = i64::try_from(target).unwrap()
                - i64::try_from(from.checked_add(5).unwrap()).unwrap();
            i32::try_from(displacement).unwrap().to_le_bytes()
        }

        fn apply_with_marker_adapter(plan: PatchPlan) -> Vec<u8> {
            let mut bytes = apply(plan);
            bytes.resize(MARKER_ADAPTER_OFFSET + 15, 0x90);
            assert_eq!(
            ...
            bytes[plan.fallback_branch_offset + 1..plan.fallback_branch_offset + 5]
                .copy_from_slice(&rel32(plan.fallback_branch_offset, MARKER_ADAPTER_OFFSET));
            bytes[MARKER_ADAPTER_OFFSET..MARKER_ADAPTER_OFFSET + 2].copy_from_slice(&[0x48, 0xb8]);
            bytes[MARKER_ADAPTER_OFFSET + 2..MARKER_ADAPTER_OFFSET + 10]
                .copy_from_slice(&(MARKER_ADAPTER_RESULT as i64).to_le_bytes());
            bytes[MARKER_ADAPTER_OFFSET + 10] = 0xe9;
            bytes[MARKER_ADAPTER_OFFSET + 11..MARKER_ADAPTER_OFFSET + 15].copy_from_slice(&rel32(
                MARKER_ADAPTER_OFFSET + 10,
        ...
        fn synthetic_elf(symbols: &[SyntheticSymbol], load_vaddr: u64) -> Vec<u8> {
            ...
            put_u64(
                ...
                (SYNTHETIC_ELF_FUNCTION_OFFSET + KNOWN_GETRANDOM.len() - SYNTHETIC_CODE_OFFSET)
                    as u64,
            );
            ...
            // The reviewed adapter source is eight bytes beginning at function
            ...
            image[SYNTHETIC_CODE_OFFSET..SYNTHETIC_ELF_FUNCTION_OFFSET + KNOWN_GETRANDOM.len() + 1]
                .fill(0x90);
        ...
        fn known_vdso_image() -> Vec<u8> {
            KNOWN_VDSO_IMAGE_HEX
                ...
                .iter()
                .map(|encoded| {
                    hex_nibble(encoded[0]).unwrap() << 4 | hex_nibble(encoded[1]).unwrap()
                })
                .collect()
        }
        ...
        fn synthetic_elf_binds_every_public_getrandom_alias() {
            ...
            // The adapter design does not rewrite the original syscall or its
            ...
            let mut untouched_tail_entry = SyntheticSymbol::function(
                "third_getrandom_tail_entry",
        ...
        fn synthetic_elf_refuses_outside_direct_entries_into_changed_instructions() {
            ...
            rewritten_interiors.extend(
                (1..5).map(|offset| SYNTHETIC_ELF_FUNCTION_OFFSET + REDIRECT_OFFSET + offset),
            );
            rewritten_interiors
                .extend((1..5).map(|offset| {
                    SYNTHETIC_ELF_FUNCTION_OFFSET + GENERAL_FALLBACK_OFFSET + offset
                }));
            rewritten_interiors
        ...
        fn synthetic_elf_refuses_ifunc_and_extra_computed_targets_for_the_actual_reason() {
            let mut ifunc =
                SyntheticSymbol::function("computed_ifunc", goblin::elf::sym::STB_GLOBAL);
        ...
        fn synthetic_elf_refuses_invalid_symbols_and_load_geometry() {
            ...
            wrong_alias_binding.info =
                goblin::elf::sym::STB_GLOBAL << 4 | goblin::elf::sym::STT_FUNC;
            ...
            invalid_loads.push(writable_executable);
            ...
            invalid_loads.push(two_executable_loads);
            ...
            invalid_loads.push(tight_executable_load);

            for image in invalid_loads {
                assert!(parsed_plan(&image).is_err());
            }
        }
        ...
        #[test]
        fn copied_machine_code_preserves_query_and_routes_every_fallback_to_the_adapter() {
            let plan = plan(Some(KNOWN_GETRANDOM)).unwrap().unwrap();
            let baseline_mapping = SyntheticVdso::new(KNOWN_GETRANDOM);
            let adapter_bytes = apply_with_marker_adapter(plan);
            let patched_mapping = SyntheticVdso::new(&adapter_bytes);
            let not_ready_mapping = SyntheticVdso::new_with_ready(&adapter_bytes, false);
        ...
        #[test]
        fn normal_and_fallback_branches_target_the_adapter_without_touching_the_syscall() {
            let plan = plan(Some(KNOWN_GETRANDOM)).unwrap().unwrap();
            let patched = apply_with_marker_adapter(plan);
            ...
            assert_eq!(
                rel32_target(
                    &patched,
                    MARKER_ADAPTER_OFFSET + 11,
                    MARKER_ADAPTER_OFFSET + 15,
                ),
                Some(COMMON_EPILOGUE_OFFSET),
            );
        }
        ...
        #[test]
        fn every_adapter_source_word_mutation_is_refused() {
            let canonical = [SyntheticSymbol::canonical()];
            ...
            for word_offset in 0..INTERNAL_SYSCALL_WORD.len() {
                ...
                changed[SYNTHETIC_ELF_FUNCTION_OFFSET + GENERAL_SYSCALL_OFFSET + word_offset] ^=
                    0x01;
                let error = parsed_plan(&changed).unwrap_err();
                let expected_reason = if word_offset + 1 == INTERNAL_SYSCALL_WORD.len() {
                    "adapter source word changed"
                } else {
                    "function bytes or size changed"
                };
                assert!(
                    error.to_string().contains(expected_reason),
                    "changed adapter-source byte {word_offset} reached the wrong refusal: {error}"
                );
            }
        }
    }
...
/// Exact bytes that the in-process backend publishes around hook activation.
#[derive(Clone, Debug)]
pub enum VdsoEntryPatch {
    /// Rewrite an ordinary vDSO function into a syscall before hooking it.
    BeforeHook {
        /// Address of the ordinary vDSO entry point to rewrite.
        address: u64,
        /// Exact original function bytes required at `address` before the rewrite.
        expected: Box<[u8]>,
        /// Equal-length syscall, return, and padding bytes published at `address`.
        replacement: Box<[u8]>,
    },
    /// Publish two complete instruction-head redirects only after their private
    /// callback target and the sole computed-target guard are executable.
    AfterTarget {
        /// Complete recognized mapping rechecked immediately before writes.
        mapping_expected: Box<[u8]>,
        /// Complete recognized function range rechecked immediately before writes.
        function_address: u64,
        /// Exact recognized function bytes required at `function_address`.
        function_expected: Box<[u8]>,
        /// First-state-write instruction head redirected to the general fallback.
        normal_address: u64,
        /// Exact original instruction-head bytes required at `normal_address`.
        normal_expected: [u8; 5],
        /// Exact relative jump from `normal_address` to `fallback_address`.
        normal_replacement: [u8; 5],
        /// Syscall-number load redirected to the private callback target.
        fallback_address: u64,
        /// Exact original syscall-number-load bytes required at `fallback_address`.
        fallback_expected: [u8; 5],
        /// Untouched syscall and tail jump used to build the callback adapter.
        adapter_source_address: u64,
        /// Exact syscall, tail-jump, and following byte required at `adapter_source_address`.
        adapter_source_expected: [u8; 8],
        /// Start of `mov rax,[rax+0x18]; lfence`; its guarded replacement
        /// resumes at the original, untouched `call *rax`.
        indirect_guard_address: u64,
        /// Exact target-load, fence, and call bytes required at the guard address.
        indirect_guard_expected: [u8; 9],
        /// Length of the target-load and fence prefix displaced by the guard patch.
        indirect_guard_displaced_len: u8,
    },
}

/// Stable `/proc/<pid>/maps` fields captured for the special vDSO mapping.
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct VdsoMappingIdentity {
    /// File offset reported for the mapping at planning time.
    pub offset: u64,
    /// Device major and minor numbers reported for the mapping at planning time.
    pub device: (u64, u64),
    /// Inode number reported for the mapping at planning time.
    pub inode: u64,
    /// Pathname reported for the mapping at planning time.
    pub pathname: Box<str>,
    /// Whether the mapping was shared rather than private at planning time.
    pub shared: bool,
}

/// One vDSO entry point prepared for an in-guest syscall hook.
#[derive(Clone, Debug)]
pub struct VdsoSyscallSite {
    ...
    pub mapping_len: u64,
    /// Exact non-permission identity of that mapping at planning time.
    pub mapping_identity: VdsoMappingIdentity,
    /// Exact entry bytes and whether they must precede or follow hook activation.
    pub entry_patch: VdsoEntryPatch,
}

#[cfg(target_arch = "x86_64")]
fn liteinst_getrandom_is_required(subscriptions: &Subscription) -> bool {
...
fn liteinst_getrandom_symbol_layout(
    ...
    if syscall_word_end > load_end {
        return Err(std::io::Error::new(
            std::io::ErrorKind::InvalidData,
            "current vDSO getrandom adapter source crosses its executable load segment",
        )
        .into());
    }
    ...
    if observed_syscall_word != plan.syscall_word {
        return Err(std::io::Error::new(
            std::io::ErrorKind::InvalidData,
            "current vDSO getrandom adapter source word changed",
        )
        .into());
    }
    for symbol in elf.dynsyms.iter().chain(elf.syms.iter()) {
...
/// Describe the calling process's vDSO entry points for in-process hooks.
///
/// Returns each instruction's address, syscall number, exact original bytes,
/// and replacement ordering so the in-guest backend can publish or roll back
/// the complete batch while the process is still single-threaded. LiteInst
/// handles `__vdso_getrandom` separately: the five-argument query gate remains
/// intact, while every recognized non-query call is sent to the function's
/// existing general syscall fallback. Unknown present layouts and images with
/// absent ABI names but no exact reviewed route-free admission are refused
/// before writes.
///
/// Despite its historical name, this function performs no `mprotect` or code
/// write. The in-process caller must acquire its signal-state guard before this
/// function reads the live mapping and retain that guard through publication.
///
/// The ptrace stopped-guest table deliberately remains unchanged.
#[cfg(target_arch = "x86_64")]
pub fn patch_current_vdso(subscriptions: &Subscription) -> Result<Vec<VdsoSyscallSite>, Error> {
    let ordinary_patch_required = is_patch_required(subscriptions);
    let getrandom_patch_required = liteinst_getrandom_is_required(subscriptions);
    if !ordinary_patch_required && !getrandom_patch_required {
        return Ok(Vec::new());
    }
    let process =
    ...
    let expected_permissions = procfs::process::MMPermissions::READ
        | procfs::process::MMPermissions::EXECUTE
        | procfs::process::MMPermissions::PRIVATE;
    if vdso.perms != expected_permissions {
        return Err(std::io::Error::new(
            std::io::ErrorKind::InvalidData,
            "current vDSO mapping does not have exact private read/execute protection",
        )
        .into());
    }
    let mapping_identity = VdsoMappingIdentity {
        offset: vdso.offset,
        device: (
            u64::try_from(vdso.dev.0).map_err(|_| Errno::EINVAL)?,
            u64::try_from(vdso.dev.1).map_err(|_| Errno::EINVAL)?,
        ),
        inode: vdso.inode,
        pathname: "[vdso]".into(),
        shared: vdso.perms.contains(procfs::process::MMPermissions::SHARED),
    };
    let image = unsafe { std::slice::from_raw_parts(start as *const u8, len) };
    let getrandom_plan = if getrandom_patch_required {
        liteinst_getrandom_symbol(image)?
    } else {
        None
    };
    if !ordinary_patch_required && getrandom_plan.is_none() {
        return Ok(Vec::new());
    }
    let mapping_end = start.checked_add(len).ok_or(Errno::EOVERFLOW)?;
    let getrandom_site = getrandom_plan
        .map(|(symbol_offset, plan)| {
            let symbol = start.checked_add(symbol_offset).ok_or(Errno::EOVERFLOW)?;
            let normal = symbol
                .checked_add(plan.normal_branch_offset)
                .ok_or(Errno::EOVERFLOW)?;
            let normal_end = normal
                .checked_add(plan.normal_branch_bytes.len())
                .ok_or(Errno::EOVERFLOW)?;
            let fallback = symbol
                .checked_add(plan.fallback_branch_offset)
                .ok_or(Errno::EOVERFLOW)?;
            let fallback_end = fallback
                .checked_add(plan.fallback_branch_expected.len())
                .ok_or(Errno::EOVERFLOW)?;
            let syscall = symbol
                .checked_add(plan.syscall_offset)
                .ok_or(Errno::EOVERFLOW)?;
            let syscall_word_end = syscall
                .checked_add(plan.syscall_word.len())
                .ok_or(Errno::EOVERFLOW)?;
            let function_end = symbol
                .checked_add(vdso_getrandom_x86_64::KNOWN_GETRANDOM.len())
                .ok_or(Errno::EOVERFLOW)?;
            let indirect_guard = start
                .checked_add(vdso_getrandom_x86_64::SGX_TARGET_LOAD_OFFSET)
                .ok_or(Errno::EOVERFLOW)?;
            let indirect_guard_end = indirect_guard
                .checked_add(vdso_getrandom_x86_64::SGX_GUARD_SOURCE.len())
                .ok_or(Errno::EOVERFLOW)?;
            if normal_end > mapping_end
                || fallback_end > mapping_end
                || syscall_word_end > mapping_end
                || function_end > mapping_end
                || indirect_guard_end > mapping_end
            {
                return Err(Errno::EFAULT);
            }
            let observed_syscall_word = image
                .get(
                    symbol_offset + plan.syscall_offset
                        ..symbol_offset + plan.syscall_offset + plan.syscall_word.len(),
                )
                .ok_or(Errno::EFAULT)?;
            if observed_syscall_word != plan.syscall_word {
            ...
            Ok(VdsoSyscallSite {
                address: syscall as u64,
                number: libc::SYS_getrandom,
                mapping_start: start as u64,
                mapping_len: len as u64,
                mapping_identity: mapping_identity.clone(),
                entry_patch: VdsoEntryPatch::AfterTarget {
                    mapping_expected: image.to_vec().into_boxed_slice(),
                    function_address: symbol as u64,
                    function_expected: vdso_getrandom_x86_64::KNOWN_GETRANDOM
                        .to_vec()
                        .into_boxed_slice(),
                    normal_address: normal as u64,
                    normal_expected: plan.normal_branch_expected,
                    normal_replacement: plan.normal_branch_bytes,
                    fallback_address: fallback as u64,
                    fallback_expected: plan.fallback_branch_expected,
                    adapter_source_address: syscall as u64,
                    adapter_source_expected: plan.syscall_word,
                    indirect_guard_address: indirect_guard as u64,
                    indirect_guard_expected: vdso_getrandom_x86_64::SGX_GUARD_SOURCE,
                    indirect_guard_displaced_len: u8::try_from(
                        vdso_getrandom_x86_64::SGX_GUARD_DISPLACED_LEN,
                    )
    ...
    // Install and publish getrandom before doing any other returned site work.
    syscall_sites.extend(getrandom_site);
    if ordinary_patch_required {
        for (name, (offset, size, _bytes, _sysno)) in subscribed_vdso_patches(subscriptions) {
            let symbol_offset = usize::try_from(*offset).map_err(|_| Errno::EOVERFLOW)?;
            let symbol = start.checked_add(symbol_offset).ok_or(Errno::EOVERFLOW)?;
            let symbol_end = symbol.checked_add(*size).ok_or(Errno::EOVERFLOW)?;
            if symbol_end > mapping_end {
            ...
            assert!(*size >= 3);
            let expected = image[symbol_offset..symbol_offset + *size]
                .to_vec()
                .into_boxed_slice();
            let mut replacement = vec![0x90; *size];
            ...
            syscall_sites.push(VdsoSyscallSite {
                ...
                mapping_len: len as u64,
                mapping_identity: mapping_identity.clone(),
                entry_patch: VdsoEntryPatch::BeforeHook {
                    address: symbol as u64,
                    expected,
