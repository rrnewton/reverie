...
unit='dbt-loader-pin-provision1-20260917.scope'
...
assert raw['memory.max'].strip()=='4294967296' and raw['memory.swap.max'].strip()=='0' and raw['cpu.max'].strip()=='200000 100000' and raw['pids.max'].strip()=='1024'
assert int(Path('/proc/2162531/stat').read_text().rsplit(') ',1)[1].split()[19])==166139008
assert not Path('/home/newton/work/dev-hermit/worktrees/slots/dev-hermit-dbt-loader-pin-20260917').exists()
os.environ['TG_DB_PATH']='/home/newton/.tg/hermit2.db'
