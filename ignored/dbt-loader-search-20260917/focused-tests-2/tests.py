...
assert before['reverie-dbt/tests/private_loader_search.rs']=='178281289c800b6c315367a2c208cbe43adee52348a99829f931992122e15f89'
...
commands=[('list',['cargo','test','-vv','--offline','--locked','-p','reverie-dbt','--test','private_loader_search','--','--list']),('tests',['cargo','test','--offline','--locked','-p','reverie-dbt','--test','private_loader_search','--','--test-threads=1','--nocapture']),('fmt',['cargo','fmt','--all','--','--check']),('clippy',['cargo','clippy','--offline','--locked','-p','reverie-dbt','--all-targets','--all-features'])]
