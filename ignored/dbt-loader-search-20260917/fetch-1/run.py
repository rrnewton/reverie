...
unit='dbt-loader-fetch1-20260917.scope'
...
assert raw['memory.max'].strip()=='2147483648' and raw['memory.swap.max'].strip()=='0' and raw['cpu.max'].strip()=='200000 100000' and raw['pids.max'].strip()=='256'
