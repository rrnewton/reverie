...
// TODO-HUMAN-REVIEW(PR-272): Review the guest vDSO placement and note contents.
...
// TODO-HUMAN-REVIEW(PR-272): Review the synthetic vDSO ELF layout and note.
//
...
const GUEST_LINUX_VERSION_CODE: u32 = (6 << 16) | (0 << 8) | 0;
