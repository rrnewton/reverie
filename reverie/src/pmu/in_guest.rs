...
use crate::pmu::perf::Builder;
use crate::pmu::perf::PerfCounter;
...
impl InGuestRcbCounter {
    ...
    #[inline(always)]
    pub fn sample_once(&self) -> crate::pmu::InGuestRcbSample {
...
pub struct InGuestRcbTimer {
    ...
    signal: crate::Signal,
    generation: u64,
    deadline: Option<crate::pmu::InGuestRcbDeadline>,
    skid_margin: u64,
...
impl InGuestRcbTimer {
    ...
    fn current_thread_with_config(
        ...
        if matches!(signal, crate::Signal::SIGKILL | crate::Signal::SIGSTOP) {
        ...
        counter.set_signal_delivery(crate::Tid::from_raw(thread as i32), signal)?;
        Ok(Self {
            counter,
            signal,
            generation: 0,
    ...
    pub fn prepare_after(&mut self, clock: u64, rcbs: u64) -> Result<u64, Errno> {
        ...
        let deadline = crate::pmu::InGuestRcbDeadline::new(clock, rcbs).ok_or(Errno::EOVERFLOW)?;
    ...
    pub fn observe_notification(
        ...
        arm: u64,
        clock: u64,
    ) -> Result<crate::pmu::InGuestRcbDeadlineStatus, Errno> {
        use crate::pmu::InGuestRcbDeadlineStatus;
...
mod tests {
    ...
    fn construction_is_disabled_and_signal_setup_uses_trusted_gate() {
        ...
        CALLS.with_borrow(|calls| {
            ...
            assert_eq!(
                calls[4],
                (libc::SYS_fcntl, 10, crate::Signal::SIGSTKFLT as u64)
            );
        });
    }
    ...
    fn notification_requires_signal_poll_source_and_protected_fd() {
        ...
        let signal = crate::Signal::SIGSTKFLT as i32;
    ...
    fn cancelled_and_old_callbacks_do_not_touch_the_new_arm() {
        use crate::pmu::InGuestRcbDeadlineStatus::Cancelled;
        let mut timer = notification_timer();
    ...
    fn late_kernel_wakeup_is_checked_against_current_deadline() {
        use crate::pmu::InGuestRcbDeadlineStatus::Cancelled;
        use crate::pmu::InGuestRcbDeadlineStatus::Reached;
        use crate::pmu::InGuestRcbDeadlineStatus::Remaining;
        let mut timer = notification_timer();
    ...
    fn overshoot_is_not_precise_success_and_consumes_the_request() {
        use crate::pmu::InGuestRcbDeadlineStatus::Cancelled;
        use crate::pmu::InGuestRcbDeadlineStatus::Overshot;
        let mut timer = notification_timer();
    ...
    fn all_programming_failures_cancel_and_propagate_without_accepting_callbacks() {
        ...
        for request in [perf::DISABLE, perf::RESET, perf::PERIOD, perf::ENABLE] {
            ...
            assert_eq!(
                ...
                Ok(crate::pmu::InGuestRcbDeadlineStatus::Cancelled)
            );
            FAIL_COMMAND.set(None);
    ...
    fn hardware_notifications_rearm_and_cancel() {
        std::thread::spawn(|| {
            ...
            let signal = crate::Signal::SIGSTKFLT;
            ...
            let sample = || {
                for _ in 0..100 {
                    ...
                    match clock.sample_once() {
                        crate::pmu::InGuestRcbSample::Value(count) => {
                        ...
                        crate::pmu::InGuestRcbSample::Retry => continue,
